...
import GemmaAtom from '../lib/gemma-atom';
...
describe('GemmaAtom', () => {
  ...
  describe('when the gemma-atom:convert event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      // has been created
      expect(workspaceElement.querySelector('.gemma-atom')).not.toExist();
      ...
      runs(() => {
        expect(workspaceElement.querySelector('.gemma-atom')).toExist();

        let gemmaAtomElement = workspaceElement.querySelector('.gemma-atom');
        expect(gemmaAtomElement).toExist();
